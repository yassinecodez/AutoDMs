  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-5xl">
      ...
      <div className="space-y-0.5 pb-2 border-b border-[#222222]">
        <h1 className="text-xl font-bold text-white tracking-tight">Billing & limits</h1>
      ...
      {/* Usage Meter Card */}
      <div className="p-5 bg-[#0A0A0A] border border-[#222222] rounded-xl space-y-3.5 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="px-2.5 py-1 rounded-md bg-[#111111] border border-[#222222] text-white text-xs font-medium w-fit">
        ...
        <div className="space-y-1.5 pt-1">
          <div className="flex justify-between text-xs font-medium">
            ...
            <span className="text-zinc-300">{usagePercentage}% consumed</span>
          </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {/* Card 1: FREE Starter */}
          <div className={`p-6 bg-[#0A0A0A] rounded-xl flex flex-col justify-between h-[370px] border transition-all ${
            user.planType === "FREE"
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <span className="text-[10px] uppercase font-semibold text-zinc-500 tracking-wider">Starter tier</span>
              ...
              <div className="space-y-0.5 py-1">
                <p className="text-2xl font-bold text-white">$0 <span className="text-xs font-normal text-zinc-500">/ forever</span></p>
                <p className="text-[10px] text-zinc-500 font-medium uppercase tracking-wider">0 DH per month</p>
              </div>
          ...
          {/* Card 2: Creator PRO */}
          <div className={`p-6 bg-[#0A0A0A] rounded-xl flex flex-col justify-between h-[370px] border transition-all relative ${
            user.planType === "PRO"
              ? "border-white/40 ring-1 ring-white/20 shadow-xl"
              : "border-[#222222] hover:border-zinc-700"
          }`}>
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <span className="text-[10px] uppercase font-semibold text-zinc-400 tracking-wider">Professional tier</span>
                <h3 className="text-sm font-bold text-white">Creator Pro</h3>
                <p className="text-xs text-zinc-400 leading-normal">High volume triggers & story rewards.</p>
              </div>
              <div className="space-y-0.5 py-1">
                <p className="text-2xl font-bold text-white">$5 <span className="text-xs font-normal text-zinc-500">/ month</span></p>
                <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-wider">50 DH per month</p>
              </div>
              <ul className="text-xs space-y-2 text-zinc-300 border-t border-[#1F1F1F] pt-4">
                <li className="flex items-center gap-2">
                  <Check className="w-3.5 h-3.5 text-zinc-400 shrink-0" strokeWidth={2} />
          ...
          <div className={`p-6 bg-[#0A0A0A] rounded-xl flex flex-col justify-between h-[370px] border transition-all ${
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <span className="text-[10px] uppercase font-semibold text-zinc-400 tracking-wider">Agency tier</span>
                <h3 className="text-sm font-bold text-white">Business / Agency</h3>
                <p className="text-xs text-zinc-400 leading-normal">Multi-account scale for agencies & brands.</p>
              </div>
              <div className="space-y-0.5 py-1">
                <p className="text-2xl font-bold text-white">$15 <span className="text-xs font-normal text-zinc-500">/ month</span></p>
                <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-wider">150 DH per month</p>
              </div>
              <ul className="text-xs space-y-2 text-zinc-300 border-t border-[#1F1F1F] pt-4">
                <li className="flex items-center gap-2">
                  <Check className="w-3.5 h-3.5 text-zinc-400 shrink-0" strokeWidth={2} />
